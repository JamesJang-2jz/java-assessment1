...
//        return sentence.split(" ")[0];
     ...
     * @param sentence a string containing words delimited by spaces, representative of a sentence
     * @return the first word in the specified sentence, with identical contents in reverse order
     * and the first character capitalized given a string containing words delimited by spaces,
     * representative of a sentence, return the first word with identical contents in reverse
     ...
     * given a string and index, return an identical string excluding the character at the
     * specified index
     */
